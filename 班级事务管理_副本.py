...
# ==========================================
# 1. 本地存储配置：D盘目录初始化与智能兼容
# ==========================================
WORKSPACE_DIR = r"D:\Class12_Workspace"

# 如果在 Mac 上运行（没有D盘），临时降级到用户目录以供开发测试，防止崩溃
if not os.path.exists("D:\\") and sys.platform == 'darwin':
...
if not os.path.exists(WORKSPACE_DIR):
    try:
        ...
        print(f"工作区已成功创建: {WORKSPACE_DIR}")
    except Exception as e:
        print(f"文件夹创建失败。错误信息: {e}")
...
class OverviewClickableCard(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.text_label.setStyleSheet(
            "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; line-height: 1.5; color: #000000; border: none; background: transparent;")
...
class DeductionDashboardCard(ClickableFrame):
    def __init__(self, target_index):
        ...
        title_label.setStyleSheet(
            "font-family: 'Songti SC', 'STSong', serif; font-size: 28px; font-weight: bold; color: #000000; border: none; background: transparent;")
    ...
    def refresh_data(self):
        ...
        if not records:
            ...
            self.content_label.setStyleSheet(
                "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: #000000; border: none; background: transparent;")
        ...
        self.content_label.setStyleSheet(
            "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; line-height: 1.5; border: none; background: transparent;")
...
class NoticeDashboardCard(ClickableFrame):
    ...
    def refresh_data(self):
        ...
        if not records:
            ...
            self.content_label.setStyleSheet(
                "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; line-height: 1.6; color: #000000; border: none; background: transparent;")
            self.content_label.setAlignment(Qt.AlignmentFlag.AlignTop | Qt.AlignmentFlag.AlignLeft)
    ...
    def __init__(self, target_index):
        ...
        def add_period_row(num_str):
            ...
            num_label.setStyleSheet(
                "font-family: 'Songti SC', 'STSong', serif; font-size: 24px; font-weight: bold; color: #000000; border: none; background: transparent; padding-right: 5px;")
            ...
            subject_label.setStyleSheet(
                "background-color: #F4F1EA; border-radius: 6px; border: 1px solid #DFDBD1; font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: #000000;")
...
class DutyCard(ClickableFrame):
    def __init__(self, target_index):
        ...
        self.content_label = QLabel()
        self.content_label.setStyleSheet(
            "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: #000000; border: none; background: transparent; line-height: 1.8;")
        self.content_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.content_label.setWordWrap(True)
        self.content_label.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents, True)
...
class RefreshTimeDialog(QDialog):
    def __init__(self, parent=None):
        ...
        lbl.setStyleSheet(
            "font-family: 'Songti SC', 'STSong', serif; font-size: 24px; font-weight: bold; color: #000000;")
        layout.addWidget(lbl)
        self.time_edit = QTimeEdit()
        current_rt = DatabaseHelper.get_refresh_time()
        self.time_edit.setTime(QTime.fromString(current_rt, "HH:mm"))
        self.time_edit.setStyleSheet(
            "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; padding: 5px; background: white; color: #000000;")
...
class StudentMultiSelectDialog(QDialog):
    def __init__(self, parent=None):
        ...
        for i, name in enumerate(students):
            ...
            btn.setStyleSheet("""
                QPushButton { font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; background-color: #E8E4DA; border: 1px solid #D5D0C5; border-radius: 4px; color: #000000;}
...
class DeductionInputDialog(QDialog):
    def __init__(self, parent=None):
        ...
        lbl1 = QLabel("📝 扣分原因：")
        lbl1.setStyleSheet(
            "color: #000000; font-family: 'Songti SC', 'STSong', serif; font-size: 24px; font-weight: bold;")
        layout.addWidget(lbl1)
        self.reason_edit = QTextEdit()
        self.reason_edit.setFixedHeight(100)
        self.reason_edit.setStyleSheet(
            "background: white; font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; color: #000000;")
        ...
        self.points_edit.setStyleSheet(
            "background: white; font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; padding: 5px; color: #000000;")
...
class CategoryDeductionDialog(QDialog):
    ...
    def init_ui(self):
        ...
        title.setStyleSheet(
            f"font-family: 'Songti SC', 'STSong', serif; font-size: 28px; font-weight: bold; color: {self.color_txt};")
        ...
        self.browser.setStyleSheet(
            f"background-color: rgba(255,255,255,0.6); border: 1px solid {self.color_txt}; border-radius: 6px; font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; padding: 15px; line-height: 1.6; color: {self.color_txt};")
...
class DeductionQueryDialog(QDialog):
    def __init__(self, parent=None):
        ...
        for d in [self.d1, self.d2]:
            ...
            d.setStyleSheet("font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; padding: 5px; color: #000000;")
...
class DeductionPage(QWidget):
    ...
    def init_ui(self):
        ...
        btn_back.setStyleSheet(
            "QPushButton { font-family: 'Kaiti SC', 'STKaiti', serif; background-color: #E8E4DA; border: 1px solid #D5D0C5; border-radius: 4px; font-size: 24px; font-weight: bold; color: #000000;} QPushButton:hover { background-color: #DCD7CB; }")
        btn_back.clicked.connect(self.back_callback)

        title = QLabel("扣分情况提醒")
        title.setStyleSheet(
            "font-family: 'Songti SC', 'STSong', serif; font-size: 28px; font-weight: bold; color: #000000;")
        ...
        for cat_name, bg_c, txt_c in cats:
            ...
            lbl = QLabel(cat_name)
            lbl.setStyleSheet(
                f"font-family: 'Songti SC', 'STSong', serif; font-size: 28px; font-weight: bold; color: {txt_c}; border: none;")
            lbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
            lbl.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents, True)

            content_lbl = QLabel()
            content_lbl.setStyleSheet(
                f"font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: {txt_c}; border: none; line-height: 1.6;")
...
class AddNoticeDialog(QDialog):
    def __init__(self, parent=None):
        ...
        l = QVBoxLayout(self)
        self.te = QTextEdit()
        self.te.setStyleSheet("font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; color: #000000;")
        l.addWidget(self.te)
        btn = QPushButton("保存")
        btn.setFixedHeight(50)
        btn.setStyleSheet(
...
class NoticePage(QWidget):
    ...
    def init_ui(self):
        ...
        btn_add.setFixedSize(160, 50)
        btn_add.setStyleSheet(
            "QPushButton { font-family: 'Kaiti SC', 'STKaiti', serif; background-color: #000000; color: white; border-radius: 4px; font-size: 24px; font-weight: bold;} QPushButton:hover { background-color: #333333; }")
    ...
    def load_data(self):
        ...
        for nid, content in records:
            ...
            lbl.setStyleSheet(
                "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: #000000; border: none;")
            btn_del = QPushButton("×")
...
class HomeworkHistoryDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.result_browser.setStyleSheet(
            "background-color: #F8F6F1; border: 1px solid #D5D0C5; font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; padding: 15px; line-height: 1.6; color: #000000;")
...
class SubjectDialog(QDialog):
    ...
    def set_btn_style(self, btn, status):
        font = "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; border-radius: 4px;"
        if status == "已交":
...
class LateSubmissionDialog(QDialog):
    ...
    def init_ui(self):
        ...
        info_label.setStyleSheet(
            f"font-family: 'Songti SC', 'STSong', serif; font-size: 24px; font-weight: bold; color: #000000;")
        layout.addWidget(info_label)
        ...
        if not records:
            empty = QLabel("🎉 暂无未交作业记录！")
            empty.setStyleSheet(
                "font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; color: #27AE60;")
...
class HomeworkPage(QWidget):
    ...
    def init_ui(self):
        ...
        for i, sub in enumerate(["语文", "数学", "英语", "物理", "化学", "生物", "政治", "历史", "地理", "技术"]):
            ...
            btn.setStyleSheet(
                "QPushButton { background-color: #F8F6F1; color: #000000; border: 1px solid #D5D0C5; border-radius: 6px; font-family: 'Songti SC', 'STSong', serif; font-size: 28px; font-weight: bold;} QPushButton:hover { background-color: #E8E4DA; }")
        ...
        hint_label.setStyleSheet("font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 20px; color: #000000;")
        ...
        scroll.setWidget(inner_w)
        main_layout.addWidget(scroll)
        self.refresh_today_overview()  # 添加这一行，初始化时刷新作业概况
...
class SchedulePage(QWidget):
    ...
    def init_ui(self):
        ...
        self.table.setStyleSheet(
            "QTableWidget { font-family: 'Kaiti SC', 'STKaiti', serif; font-size: 24px; font-weight: bold; background-color: white; color: #000000;} QHeaderView::section { font-family: 'Songti SC', 'STSong', serif; font-size: 24px; font-weight: bold; color: #000000; }")
...
class ClassDashboard(QMainWindow):
    ...
    def init_home_page(self):
        ...
        title_label.setStyleSheet(
            "font-family: 'Songti SC', 'STSong', '宋体', serif; font-size: 32px; font-weight: bold; color: #000000; letter-spacing: 2px;")
        self.time_label = QLabel()
        self.time_label.setStyleSheet(
            "font-family: 'Kaiti SC', 'STKaiti', '楷体', serif; font-size: 24px; font-weight: bold; color: #000000;")
